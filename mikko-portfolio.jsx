...
import {
  FiMenu, FiX, FiExternalLink, FiGithub, FiMail,
  FiArrowRight, FiCode, FiLayers, FiSmartphone,
  FiShoppingCart, FiStar, FiCheck
} from "react-icons/fi";
import {
  FaWordpress, FaReact, FaHtml5, FaCss3Alt, FaJs,
  FaFigma, FaGithub, FaLinkedin, FaFacebook,
  FaEnvelope, FaCanadianMapleLeaf
} from "react-icons/fa";
import {
  SiTailwindcss, SiElementor, SiWoocommerce, SiVercel, SiCanva
} from "react-icons/si";
...
const SKILLS = {
  ...
  WordPress: [
    ...
    { label: "WooCommerce", icon: <SiWoocommerce className="text-purple-600" /> },
    { label: "Responsive Design", icon: <FiSmartphone className="text-indigo-600" /> },
    { label: "Basic SEO", icon: <FiStar className="text-amber-500" /> },
  ],
  Tools: [
    ...
    { label: "Canva", icon: <SiCanva className="text-cyan-600" /> },
  ],
};
...
const PROJECTS = [
  {
    title: "Gym Website",
    description: "A modern fitness website designed for gyms and personal trainers featuring responsive layouts, pricing sections, and strong branding.",
    tags: ["Responsive Design", "Pricing Tables", "CTA Sections", "Mobile Optimized"],
  ...
  },
  {
    ...
    description: "A modern WooCommerce-inspired online store with product showcases, category sections, and conversion-focused layouts.",
    tags: ["Product Showcase", "Shopping UI", "Responsive Layout", "Modern Store Design"],
...
const SERVICES = [
  {
    ...
    description: "Custom WordPress websites tailored to your business needs — from blog setups to full business sites with plugins, themes, and performance optimization.",
    color: "blue",
  },
  {
    icon: <FiShoppingCart size={32} />,
    title: "eCommerce Website Design",
    description: "WooCommerce-powered online stores designed for conversions — featuring product pages, cart flows, and mobile-first shopping experiences.",
    color: "violet",
  },
  {
    icon: <FiSmartphone size={32} />,
    title: "Responsive Web Design",
    description: "Pixel-perfect, fully responsive websites that look and perform beautifully on every screen size — desktop, tablet, and mobile.",
    color: "indigo",
  },
];
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8 w-full py-20 lg:py-0">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            >
              Junior WordPress Developer focused on responsive websites, WordPress development, and modern frontend experiences.
            </motion.p>
            ...
            >
              <button
                ...
                className="group flex items-center gap-2 px-6 py-3 bg-blue-600 text-white font-semibold rounded-full hover:bg-blue-700 transition-all duration-200 shadow-lg shadow-blue-200"
              >
                View Projects
              ...
              <button
                ...
                className="flex items-center gap-2 px-6 py-3 bg-white text-slate-700 font-semibold rounded-full hover:bg-slate-50 transition-all duration-200 shadow-sm ring-1 ring-slate-200"
              >
                Contact Me
              </button>
            </motion.div>
          ...
          >
            <div className="relative w-full max-w-[480px]">
              ...
              <div className="bg-slate-900 rounded-2xl shadow-2xl shadow-slate-300/60 overflow-hidden ring-1 ring-slate-800/10">
                {/* Window bar */}
                <div className="flex items-center gap-2 px-5 py-3.5 bg-slate-800 border-b border-slate-700/60">
                  <span className="w-3 h-3 rounded-full bg-red-400" />
                  <span className="w-3 h-3 rounded-full bg-yellow-400" />
                  <span className="w-3 h-3 rounded-full bg-green-400" />
                  <span className="ml-auto text-xs text-slate-400 font-mono">index.php</span>
                </div>
                {/* Code content */}
                <div className="p-5 font-mono text-sm leading-7 overflow-hidden">
                  <p><span className="text-blue-400">{"<?php"}</span></p>
                  <p><span className="text-violet-400">{"// WordPress Developer"}</span></p>
                  <p><span className="text-slate-400">$developer</span> <span className="text-white">=</span> <span className="text-green-400">array</span><span className="text-white">(</span></p>
                  <p className="pl-4"><span className="text-yellow-300">'name'</span> <span className="text-white">=&gt;</span> <span className="text-green-300">'Mikko'</span><span className="text-white">,</span></p>
                  <p className="pl-4"><span className="text-yellow-300">'role'</span> <span className="text-white">=&gt;</span> <span className="text-green-300">'WordPress Dev'</span><span className="text-white">,</span></p>
                  <p className="pl-4"><span className="text-yellow-300">'skills'</span> <span className="text-white">=&gt;</span> <span className="text-green-400">array</span><span className="text-white">(</span></p>
                  <p className="pl-8"><span className="text-green-300">'WordPress'</span><span className="text-white">,</span></p>
                  <p className="pl-8"><span className="text-green-300">'Elementor'</span><span className="text-white">,</span></p>
                  <p className="pl-8"><span className="text-green-300">'React'</span><span className="text-white">,</span></p>
                  <p className="pl-4"><span className="text-white">),</span></p>
                  <p><span className="text-white">);</span></p>
                  <p className="mt-2"><span className="text-blue-400">echo</span> <span className="text-green-300">'Building great sites!'</span><span className="text-white">;</span></p>
                  <p className="mt-1 flex items-center gap-1"><span className="text-slate-600">|</span><span className="w-2 h-4 bg-blue-400 animate-pulse rounded-sm" /></p>
                </div>
              </div>
              ...
              >
                <FaReact className="text-cyan-500 animate-spin" style={{ animationDuration: "6s" }} size={20} />
      ...
      <div className="grid lg:grid-cols-2 gap-16 items-center">
        ...
        >
          <div className="bg-gradient-to-br from-blue-50 to-indigo-100 rounded-3xl p-10 relative overflow-hidden">
            ...
            <div className="relative space-y-5">
              ...
              <div>
                <div className="text-xl font-bold text-slate-900">Mikko</div>
                <div className="text-blue-600 font-medium text-sm">Junior WordPress Developer</div>
              </div>

              {/* Tech stack chips */}
              <div className="flex flex-wrap gap-2 pt-2">
                {["WordPress", "Elementor", "WooCommerce", "React", "Tailwind", "Figma"].map((t) => (
                  <span
                    key={t}
              ...
              <div className="space-y-2 pt-2">
                {["Open to freelance projects", "Available for junior roles", "Fast learner & team player"].map((item) => (
        ...
        >
          ...
          <div className="space-y-4 text-slate-500 leading-relaxed text-[15px]">
            <p>
              Hi! I'm Mikko, a junior web developer with a strong focus on WordPress development. I enjoy crafting responsive, user-centered websites that look great and perform well on any device.
            </p>
            <p>
              I work primarily with WordPress — building custom themes, working with Elementor for visual layouts, and setting up WooCommerce stores for clients who need eCommerce solutions. I'm also expanding my skill set into modern frontend development with React and Tailwind CSS.
            </p>
            <p>
              I care deeply about clean code, pixel-perfect design, and delivering websites that truly serve the people who use them. Whether it's a business landing page or a full online store, I approach every project with attention to detail and a commitment to quality.
            </p>
          </div>
          <div className="flex flex-wrap gap-3 pt-2">
            ...
            >
              See My Work <FiArrowRight className="group-hover:translate-x-1 transition-transform" />
            </button>
            <button
              onClick={() => document.getElementById("contact")?.scrollIntoView({ behavior: "smooth" })}
      ...
      >
        {Object.entries(SKILLS).map(([category, items], ci) => (
          <motion.div
            ...
            variants={fadeUp}
            custom={ci}
            className="bg-white rounded-2xl p-6 shadow-sm ring-1 ring-slate-100 hover:shadow-md hover:-translate-y-1 transition-all duration-300"
          >
      ...
      >
        {PROJECTS.map((project, i) => (
          <motion.div
            ...
            variants={fadeUp}
            custom={i}
            className="group bg-white rounded-2xl overflow-hidden shadow-sm ring-1 ring-slate-100 hover:shadow-xl hover:-translate-y-2 transition-all duration-400"
          >
            {/* Image placeholder */}
            <div className={`relative h-52 bg-gradient-to-br ${project.gradient} overflow-hidden`}>
              ...
              <div className="absolute inset-0 opacity-10">
                ...
                <div className="absolute bottom-4 left-4 right-4 h-px bg-white/60" />
                <div className="absolute top-4 bottom-4 left-4 w-px bg-white/60" />
                <div className="absolute top-4 bottom-4 right-4 w-px bg-white/60" />
              </div>
              ...
              <div className="absolute text-6xl bottom-4 right-5 opacity-50">{project.emoji}</div>
            </div>
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="flex gap-3 pt-1">
                <button className="flex items-center gap-2 px-4 py-2 bg-slate-900 text-white text-sm font-semibold rounded-full hover:bg-slate-700 transition">
                  <FiExternalLink size={14} /> Live Demo
                </button>
                <button className="flex items-center gap-2 px-4 py-2 text-slate-700 text-sm font-semibold rounded-full hover:bg-slate-100 transition ring-1 ring-slate-200">
        ...
        {SERVICES.map((service, i) => {
          ...
          return (
            <motion.div
              ...
              variants={fadeUp}
              custom={i}
              className={`group bg-white rounded-2xl p-7 shadow-sm ring-1 ${c.border} hover:shadow-lg hover:-translate-y-2 transition-all duration-300 cursor-default`}
            >
              <div className={`w-14 h-14 rounded-2xl ${c.bg} flex items-center justify-center mb-5 ${c.icon} group-hover:scale-110 transition-transform duration-300`}>
                {service.icon}
              </div>
              <h3 className="font-bold text-slate-900 text-lg mb-3 leading-snug">{service.title}</h3>
              <p className="text-slate-500 text-sm leading-relaxed">{service.description}</p>
              <div className={`mt-5 pt-5 border-t ${c.border} flex items-center gap-1 text-sm font-semibold ${c.icon}`}>
    ...
    <Section id="contact" className="bg-white">
      ...
      >
        ...
        <motion.div variants={fadeUp} className="space-y-8">
          <div>
            ...
            <p className="text-slate-500 text-sm leading-relaxed">
              I'm currently looking for freelance projects and junior developer roles. Whether you have a project in mind or just want to connect, I'd love to hear from you.
            </p>
          </div>
            ...
            {[
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-sm font-semibold text-slate-700 group-hover:text-blue-600 transition">{value}</div>
                </div>
              </a>
            ))}
          </div>
        ...
        <motion.div
          variants={fadeUp}
          custom={1}
          className="bg-slate-50 rounded-2xl p-7 ring-1 ring-slate-100"
        >
          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 bg-white rounded-xl ring-1 ring-slate-200 text-slate-900 text-sm placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-400 transition"
              />
            </div>
            <div>
              <label className="block text-xs font-semibold text-slate-500 uppercase tracking-wider mb-1.5">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-4 py-3 bg-white rounded-xl ring-1 ring-slate-200 text-slate-900 text-sm placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-400 transition resize-none"
              />
            </div>
            <button className="w-full py-3 bg-blue-600 text-white font-semibold rounded-xl hover:bg-blue-700 transition shadow-sm shadow-blue-200 flex items-center justify-center gap-2">
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="text-center md:text-left">
            ...
            <p className="text-slate-400 text-sm mt-1">Junior WordPress Developer</p>
          </div>
          ...
          <div className="flex items-center gap-3">
            {[
              ...
              { icon: <FaEnvelope size={18} />, href: "mailto:mikko@example.com" },
            ].map(({ icon, href }, i) => (
              <a
                key={i}
                href={href}
        ...
        <div className="mt-8 pt-8 border-t border-slate-800 text-center text-sm text-slate-500">
          © {new Date().getFullYear()} Mikko Dot Dev. All rights reserved. Built with React & Tailwind CSS.
        </div>
      </div>
    </footer>
  );
